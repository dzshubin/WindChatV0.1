...
namespace WindChat
{
    public class Compression
    {
        ...
        /// <returns>解压缩后的string</returns>
        public static string deCompressBytesReString(byte[] sourceByte)
        {
            byte[] de_byte = deCompressBytes(sourceByte);
            return Encoding.UTF8.GetString(de_byte);
        }
